...
import { Container, Options, InputName, InputPixelsCount, ButtonEraser, ButtonReset, ButtonDownload, InputColor, ButtonExport, FormImport, InputImport, ButtonImport, PixelArt } from '../../styles/pages/arts/make'
import Pixel from '../../components/pages/arts/make/Pixel'
